...
def load_data(control,alpha,min_negative_jump,err_thr,mode=None,cores=None):
    ...
    for i in files:
        if 'Thr'+str(err_thr)+'_' in i and control in i and str(alpha) in i \
...
if __name__ == '__main__':
    ...
    plt.hist(length_1,bins=bin_edges,color='blue', edgecolor='black', alpha=.5)
    plt.hist(length_2,bins=bin_edges,color='yellow', edgecolor='black', alpha=.5)
